<div class="max-w-screen-xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        @forelse($articles as $article)
            <article class="bg-[#18181C] rounded-lg border border-white/10 transition-colors hover:bg-[#333233] overflow-hidden flex flex-col h-full">
                ...
                <div class="p-5 flex-1 flex flex-col">
                    ...
                    <h2 class="text-xl font-bold text-white leading-tight mb-3 flex-1">
                    ...
                    <div class="mt-auto pt-4 border-t border-white/10 text-sm text-gray-500 flex items-center">
