    ...
    @if ($mainArticle)
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="group relative">
                ...
                <div class="mt-4">
                    <h3 class="text-xl md:text-2xl font-bold text-white [html[data-theme=light]_&]:text-gray-900 leading-tight group-hover:text-red-primary transition-colors duration-300">
                ...
                @forelse ($asideArticles as $article)
                    <div class="group flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h4 class="text-md font-semibold text-white [html[data-theme=light]_&]:text-gray-900 leading-tight group-hover:text-red-primary transition-colors duration-300 line-clamp-2">
