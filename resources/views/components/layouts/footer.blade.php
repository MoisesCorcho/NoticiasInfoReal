        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="#" class="text-gray-400 hover:text-white transition-colors" aria-label="X (Twitter)">
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div>
                <h3 class="text-white text-sm font-bold uppercase tracking-wider mb-4">Secciones</h3>
                <ul class="space-y-2">
                    <li>
                    ...
                    @foreach($footerCategories as $category)
                        <li>
                            <a href="{{ route('category.show', $category->slug) }}" class="hover:text-white transition-colors">
                                {{ $category->name }}
                            </a>
                        </li>
                    @endforeach
