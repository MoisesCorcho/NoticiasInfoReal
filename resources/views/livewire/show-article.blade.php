    ...
    <div class="lg:col-span-2">
        <article class="bg-[#18181C] [html[data-theme=light]_&]:bg-white p-6 rounded-lg border border-white/10 [html[data-theme=light]_&]:border-gray-200 mb-8 transition-colors duration-200">
            ...
            <header class="mb-6">
                ...
                {{-- Metadatos --}}
                <div class="flex items-center text-gray-400 [html[data-theme=light]_&]:text-gray-600 text-sm space-x-4 border-b border-white/10 [html[data-theme=light]_&]:border-gray-200 pb-4 mb-6 transition-colors duration-200">
